...
TArray<FAssetInfo> StubFillerOperation::Objects;

void StubFillerOperation::ParseFunction(TArray<TSharedPtr<FJsonValue>> FunctionType, FAssetInfo &Info, const EType InfoType)
{
...
void StubFillerOperation::ParseJSON(const FString JsonString)
{
...
void StubFillerOperation::FillStubs(const FString JsonString)
{
