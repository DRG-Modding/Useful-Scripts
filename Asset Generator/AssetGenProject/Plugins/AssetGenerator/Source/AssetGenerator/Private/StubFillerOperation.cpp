...
TArray<FInfo> StubFillerOperation::Objects;

void StubFillerOperation::ParseFunction(TArray<TSharedPtr<FJsonValue>> FunctionType, FInfo& Info, const EType InfoType)
{
